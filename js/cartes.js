...
const popup_carte= document.getElementById('popup_carte');
const popup_img2 = document.getElementById('popup_img2');
const popup_title = document.getElementById('popup_title');
popup_carte.addEventListener('click',()=>{ 
    popup_carte.classList.remove('show');
})
...
const wheelTurn = ()=>{
    ...
    wheel_animation.addEventListener('finish',()=>{
        ...
        wheel_animation.addEventListener('finish',()=>{
            ...
            popup_img2.src = './images/'+lots[selected_lot].image;
            popup_title.innerText = lots[selected_lot].name;
            popup_carte.classList.add('show');   
